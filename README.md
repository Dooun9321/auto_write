# Auto Write - Data Analysis Agent

LangGraph 기반의 자동 데이터 분석 및 문서 작성 에이전트입니다. 사용자의 질문을 받아 BigQuery에서 데이터를 분석하고, 결과를 해석하며, Confluence에 자동으로 문서를 작성합니다.

## 🌟 주요 기능

- **자동 SQL 쿼리 생성**: 사용자 질문을 분석하여 BigQuery SQL 쿼리 자동 생성
- **코드 저장소 분석**: Git 저장소의 기존 쿼리를 분석하여 패턴 학습
- **데이터 분석**: 쿼리 실행 결과를 AI가 분석하여 인사이트 제공
- **자동 문서화**: 분석 결과를 전문적인 문서로 자동 작성
- **Confluence 통합**: 생성된 문서를 Confluence에 자동 발행
- **Streamlit UI**: 사용하기 쉬운 웹 인터페이스
...
│       LangGraph Agent               │
│  ┌─────────────────────────────┐   │
│  │  1. Code Analysis           │   │  Git 저장소 분석
│  └─────────────────────────────┘   │
│  ┌─────────────────────────────┐   │
│  │  2. Query Generation        │   │  LLM으로 SQL 생성
│  └─────────────────────────────┘   │
│  ┌─────────────────────────────┐   │
